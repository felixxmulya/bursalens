        ...
        <section className="flex flex-col-reverse md:flex-row md:h-screen md:items-center md:justify-around px-12 py-12 md:px-32 bg-gray-50">
            <div className="max-w-2xl mt-8 md:mt-0">
                ...
                <h1 className="text-4xl font-bold mb-4">
                    Smart Indonesian Stock <br />
                    Predictions Using <span className="text-blue-600">AI</span>
                </h1>
                ...
                <div className="flex flex-col md:flex-row md:space-x-4 text-center">
                    <Link href="/news" className="px-6 py-3 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition-color duration-300 mb-3 md:mb-0">
                        Read News
                    </Link>
                    <Link href="/prediction" className="px-6 py-3 text-blue-600 border border-blue-600 rounded-lg transition-color duration-300 hover:bg-blue-600 hover:text-white">
