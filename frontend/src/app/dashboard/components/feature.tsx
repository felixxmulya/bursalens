...
export default function Feature() {
    ...
    return (
        <div id="feature" className="flex flex-col items-center justify-center h-full md:h-screen md:px-32 bg-gray-50">
            <h1 className="text-3xl font-bold mt-8">Why Choose Us</h1>
